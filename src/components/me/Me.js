      ...
      <div className={styles.container}>
        ...
        <div className={`${styles.content} ${styles.revealItem}`}>
          ...
          <div className={styles.textBlock}>
            ...
            <p className={styles.paragraph}>
              היום, אחרי יותר מ־35 שנות ניסיון, אני לא רק בונה ומעצבת ציפורניים, אני גם מלמדת נשים אחרות איך להפוך את האהבה שלהן לקריירה. הקורסים שלי קטנים ואישיים, כי אני מאמינה שכל אחת ראויה לליווי אמיתי. אני איתך בכל צעד - לא רק מלמדת טכניקה, אלא גם איך לבנות ביטחון, קליינטורה יציבה ועסק שמכניס כסף מבלי לאבד את ההנאה.
            </p>
